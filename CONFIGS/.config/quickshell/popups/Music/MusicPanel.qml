...
PopupWindow {
    ...
    NumberAnimation on catppuccinFlowOffset {
        from: 0; to: 1.0; duration: 8000; loops: Animation.Infinite; running: true
    }
    ...
    SequentialAnimation {
        id: eqLightningAnim
        running: false
        ScriptAction { script: { eqLightningFade = 0.0; eqLightningProgress = 0.0; } }
        NumberAnimation { target: musicPopup; property: "eqLightningProgress"; from: 0; to: 10; duration: 650; easing.type: Easing.OutSine }
        PauseAnimation { duration: 150 }
        NumberAnimation { target: musicPopup; property: "eqLightningFade"; from: 0; to: 1; duration: 800; easing.type: Easing.OutQuad }
        ScriptAction { script: { eqLightningProgress = 0.0; } }
    }
    ...
    ParallelAnimation {
        running: true
        NumberAnimation { target: musicPopup; property: "introMain"; from: 0; to: 1; duration: 760; easing.type: Easing.OutQuart }
        SequentialAnimation {
            PauseAnimation { duration: 70 }
            NumberAnimation { target: musicPopup; property: "introCover"; from: 0; to: 1; duration: 810; easing.type: Easing.OutBack; easing.overshoot: 1.0 }
        }
        SequentialAnimation {
            PauseAnimation { duration: 150 }
            NumberAnimation { target: musicPopup; property: "introText"; from: 0; to: 1; duration: 760; easing.type: Easing.OutQuart }
        }
        SequentialAnimation {
            PauseAnimation { duration: 230 }
            NumberAnimation { target: musicPopup; property: "introControls"; from: 0; to: 1; duration: 760; easing.type: Easing.OutBack; easing.overshoot: 0.8 }
        }
        SequentialAnimation {
            PauseAnimation { duration: 310 }
            NumberAnimation { target: musicPopup; property: "introSeparator"; from: 0; to: 1; duration: 660; easing.type: Easing.OutQuart }
        }
        SequentialAnimation {
            PauseAnimation { duration: 370 }
            NumberAnimation { target: musicPopup; property: "introEqHeader"; from: 0; to: 1; duration: 710; easing.type: Easing.OutQuart }
        }
        SequentialAnimation {
            PauseAnimation { duration: 430 }
            NumberAnimation { target: musicPopup; property: "introEqSliders"; from: 0; to: 1; duration: 860; easing.type: Easing.OutExpo }
        }
        SequentialAnimation {
            PauseAnimation { duration: 550 }
            NumberAnimation { target: musicPopup; property: "introPresets"; from: 0; to: 1; duration: 810; easing.type: Easing.OutBack; easing.overshoot: 0.8 }
        }
    }
    ...
    Process {
        ...
        stdout: StdioCollector {
            onStreamFinished: {
                if (Date.now() - lastEqUpdate < 2000) return;
                try { eqData = JSON.parse(text.trim()); } catch(e) {}
            }
        }
    }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    radius: 60; color: theme.colSecondary
                    border.width: 4; border.color: musicData.status === "Playing" ? mauve : theme.colSurfaceVariant
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            radius: 6; color: mauve
                            Behavior on width { NumberAnimation { duration: 400; easing.type: Easing.OutSine } }
                        }
                    }
                    RowLayout {
                        Text { text: musicData.positionStr; color: theme.colOnSurfaceVariant; font.pixelSize: config.fontSize*0.7 }
                        Item { Layout.fillWidth: true }
                        Text { text: musicData.lengthStr; color: theme.colOnSurfaceVariant; font.pixelSize: config.fontSize*0.7 }
                    }
                }
            }
            ...
            RowLayout {
                ...
                spacing: 25
                Rectangle {
                    width: 30; height: 30; radius: 15; color: theme.colSecondary
                    Text { anchors.centerIn: parent; text: "⏮"; color: theme.colOnSecondary; font.pixelSize: config.fontSize*1.2 }
                    MouseArea {
                ...
                Rectangle {
                    width: 50; height: 50; radius: 25; color: mauve
                    Text { anchors.centerIn: parent; text: musicData.status === "Playing" ? "⏸" : "▶"; color: "#fff"; font.pixelSize: config.fontSize*2 }
                    MouseArea {
                        anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            userToggledPlay = true;
                            var temp = Object.assign({}, musicData);
            ...
            // ─── Separator ───
            Rectangle { Layout.fillWidth: true; height: 1; color: theme.colSurfaceVariant; opacity: 0.3 }

            // ─── Equalizer Header ───
            RowLayout {
                Layout.fillWidth: true
                Text { text: "Equalizer"; color: mauve; font.pixelSize: config.fontSize*1.1; font.weight: Font.DemiBold; Layout.fillWidth: true }
                Rectangle {
                    height: 24; width: applyTxt.implicitWidth + 20; radius: 12
                    ...
                    Text {
                        ...
                        font.pixelSize: config.fontSize*0.7; font.weight: Font.DemiBold
                    }
                    MouseArea {
                        anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            if (eqData.pending) {
                                var temp = Object.assign({}, eqData);
                                temp.pending = false; eqData = temp;
                                lastEqUpdate = Date.now();
                                triggerEqLightning();
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    width: parent.width; height: parent.height * ((eqData["b"+(index+1)] + 12) / 24)
                                    radius: 4; color: index % 2 === 0 ? mauve : pink
                            ...
                            Text { text: ["31","63","125","250","500","1k","2k","4k","8k","16k"][index]; color: theme.colOnSurfaceVariant; font.pixelSize: config.fontSize*0.6; Layout.alignment: Qt.AlignHCenter }
                        }
                    }
                }
            }
            ...
            // ─── Presets ───
            GridLayout {
                Layout.fillWidth: true; columns: 4; rowSpacing: 6; columnSpacing: 6
                Repeater {
