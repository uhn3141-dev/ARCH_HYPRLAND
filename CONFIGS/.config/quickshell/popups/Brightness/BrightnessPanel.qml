...
PopupWindow {
 ...
 // Blue (75-90%)
                ...
                MouseArea {
                    ...
                    onPressed: (mouse) => {
                        return setBrightness(Math.round((mouse.x / width) * 100));
                    }
                    onPositionChanged: (mouse) => {
                        if (pressed && !autoBrightness)
                            setBrightness(Math.round((mouse.x / width) * 100));
            ...
            transform: Translate {
                y: 10 * (1 - brightnessPopup.introMain)
            }
