        ...
        ColumnLayout {
            ...
            RowLayout {
                    ...
                    Text {
                        ...
                        text: {
                            ...
                            if (activeTab === "ethernet")
                                return ethernetPowered ? "⏻" : "⏼";

                            return "⏼";
                        }
                        color: {
                            if (activeTab === "wifi" && wifiPowered)
                                return "#4CAF50";

                            if (activeTab === "ethernet" && ethernetPowered)
                                return "#4CAF50";
                ...
                Rectangle {
                    ...
                    color: isHovered ? (wifiScanning ? "#FF9800" : theme.colTertiary) : (wifiScanning ? "#FF9800" : theme.colPrimary)
                    scale: isHovered ? 1.1 : 1
                ...
                ColumnLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        text: {
                            if (activeTab === "wifi" && connectedNetwork)
                                return connectedNetwork.ssid;

                            if (activeTab === "ethernet" && ethernetInfo && ethernetInfo.connected)
                                return ethernetInfo.connected.name;
                    ...
                    Text {
                        ...
                        text: {
                            if (activeTab === "wifi" && connectedNetwork)
                                return connectedNetwork.ip || "";

                            if (activeTab === "ethernet" && ethernetInfo && ethernetInfo.connected)
                                return ethernetInfo.connected.ip || "";
                    ...
                    Flickable {
                        ...
                        Column {
                                            ...
                                            ColumnLayout {
                                                ...
                                                Rectangle {
                                                    ...
                                                    RowLayout {
                                                        ...
                                                        Text {
                                                            text: wifiCard.downSpeed || "0 KB/s"
                                                            font.pixelSize: config.fontSize * 0.6
                                                            color: theme.colOnPrimaryContainer
                                                            font.weight: Font.Medium
                                                        }
                                    ...
                                    ColumnLayout {
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle {
                                                ...
                                                Text {
                                                    anchors.centerIn: parent
                                                    text: passwordField.passVisible ? "🙈" : "👁"
                                                    font.pixelSize: config.fontSize * 0.8
                                                }
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle {
                                                ...
                                                MouseArea {
                                                    ...
                                                    cursorShape: Qt.PointingHandCursor
                                                    onClicked: {
                                                        wifiCard.autoConnectEnabled = !wifiCard.autoConnectEnabled;
                                                    }
                                                }
                            ...
                            Text {
                                ...
                                text: !wifiPowered ? "WiFi is off" : (!connectedNetwork && wifiNetworks.length === 0 ? "No networks found" : "")
                        ...
                        Column {
                            ...
                            Rectangle {
                                ...
                                GridLayout {
                                    ...
                                    EthInfoRow {
                                        label: "Interface"
                                        value: ethernetInfo ? ethernetInfo.device || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "Driver"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.driver || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "IPv4"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.ip || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "Subnet"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.subnet || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "Gateway"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.gateway || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "DNS"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.dns || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "Speed"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.speed || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "Duplex"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.duplex || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "MAC"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.mac || "-" : "-"
                                    }

                                    EthInfoRow {
                                        label: "MTU"
                                        value: ethernetInfo && ethCard.isConnected ? ethernetInfo.connected.mtu || "-" : "-"
                                    }
