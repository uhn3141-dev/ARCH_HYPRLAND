...
Item {
    ...
    // ============================================================
    // Delay between each workspace button animation (ms)
    ...
    // ---- Animation Settings ----
    property int startupDelay: 150
    // Delay before showing UI (ms)
    property int animationDuration: 600
    // Duration for fade/slide animations (ms)
    property int staggerDelay: 60
